...
sleep 6;
cutText [format["Your sheep will be ready in 3 minutes!"], "PLAIN DOWN"];

sleep 180;

cutText [format["sheep are ready to be eated!!"], "PLAIN DOWN"];

deleteVehicle _earlyObj;

_lastObj = "Sheep01_EP1" createVehicle (_position);
