...
sleep 6;
cutText [format["Your wild pig will be ready in 3 minutes!"], "PLAIN DOWN"];

sleep 180;

cutText [format["wildpig are ready to be eated!!"], "PLAIN DOWN"];

deleteVehicle _earlyObj;

_lastObj = "WildBoar" createVehicle (_position);
