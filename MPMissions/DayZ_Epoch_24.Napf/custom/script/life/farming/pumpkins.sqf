...
_earlyObj = "MAP_pumpkin2" createVehicle (_position);
_earlyObj setVariable ["ObjectID", "1", true];
_earlyObj setVariable ["ObjectUID", "1", true];

player addMagazine "ItemWaterbottleUnfilled"; 

cutText [format["Nice plant!"], "PLAIN DOWN"];
sleep 6;
cutText [format["Your pumpkins will be ready in 1 minutes!"], "PLAIN DOWN"];

sleep 120;

cutText [format["Pumpkins are ready to be harvest!!"], "PLAIN DOWN"];

deleteVehicle _earlyObj;

_lastObj = "MAP_pumpkin" createVehicle (_position);
