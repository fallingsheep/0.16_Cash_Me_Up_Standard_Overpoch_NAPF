...
sleep 6;
cutText [format["Your tea plant will be ready in 3 minutes!"], "PLAIN DOWN"];

sleep 180;

cutText [format["tea plant are ready to be harvest!!"], "PLAIN DOWN"];

deleteVehicle _earlyObj;

_lastObj = "MAP_p_Helianthus" createVehicle (_position);
