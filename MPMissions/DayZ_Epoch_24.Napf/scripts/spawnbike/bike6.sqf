if (dayz_combat == 1) then { 
	...
	_pos = getpos player;
	_object = "WeaponHolder" createVehicle getposASL player; _object addMagazinecargo ["PartGeneric", 1]; _object addMagazinecargo ["PartVRotor", 1];_object addMagazinecargo ["PartGeneric", 1]; _object addMagazinecargo ["PartEngine", 1];
	_object setPos _pos;
